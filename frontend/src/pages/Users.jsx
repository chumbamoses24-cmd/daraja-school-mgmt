    ...
    <div>
      ...
      {lastCreated && (
        <div className="card p-4 mb-6 border-moss/40 bg-moss/5">
          <p className="text-sm">
            Account created for <strong>{lastCreated.email}</strong>. Temporary password:{" "}
      ...
      {showForm && (
        <form onSubmit={handleSubmit} className="card p-6 mb-6 grid grid-cols-2 gap-4">
          ...
          <div>
            ...
            <input className="input" value={form.phone} onChange={(e) => setForm({ ...form, phone: e.target.value })} placeholder="0700000000" />
          </div>
          <div>
