...
const NAV = {
  ADMIN: [
    ...
    { to: "/exams", label: "Exams", tab: "05" },
    { to: "/fees", label: "Fees", tab: "06" },
    { to: "/timetable", label: "Timetable", tab: "07" },
    { to: "/messages", label: "Messages", tab: "08" },
    { to: "/users", label: "Users", tab: "09" },
    { to: "/settings", label: "Settings", tab: "10" },
  ],
  TEACHER: [
    { to: "/", label: "Dashboard", tab: "01" },
    { to: "/students", label: "Students", tab: "02" },
